...
export class Player extends Entity{
    ...
    constructor(name, className, player_data, position){
        ...
        if(typeof stats === "undefined"){
            stats = {};
            stats.level = player_data.level;
            stats.experience = player_data.experience;
            stats.fatigue = player_data.fatigue;
            stats.fullness = player_data.fullness;
            stats.height = player_data.height;
            stats.hp = player_data.current_hp;
            stats.insanity = player_data.insanity;
            stats.weight = player_data.weight;
            stats.corruption = player_data.corruption;
        }
        ...
        for (const name in RPGClass.growths.direct) {
            if(name === "melee"){
                ...
                summed_direct["melee"] = {};
                summed_direct["melee"]["min_damage"] = RPGClass.base_stats.direct["melee"]["min_damage"] + multiplied_direct["melee"]["min_damage"];
                summed_direct["melee"]["max_damage"] = RPGClass.base_stats.direct["melee"]["max_damage"] + multiplied_direct["melee"]["max_damage"];
            }
            else if(name === "magic"){
                ...
                summed_direct["magic"] = {};
                summed_direct["magic"]["min_damage"] = RPGClass.base_stats.direct["magic"]["min_damage"] + multiplied_direct["magic"]["min_damage"];
                summed_direct["magic"]["max_damage"] = RPGClass.base_stats.direct["magic"]["max_damage"] + multiplied_direct["magic"]["max_damage"];
            }
            else if(name === "ranged"){
                ...
                summed_direct["ranged"]["min_damage"] = RPGClass.base_stats.direct["ranged"]["min_damage"] + multiplied_direct["ranged"]["min_damage"];
                summed_direct["ranged"]["max_damage"] = RPGClass.base_stats.direct["ranged"]["max_damage"] + multiplied_direct["ranged"]["max_damage"];
            }
            else{
        ...
        super(name, stats, combat_stats, RPGClass.element_strength, RPGClass.element_weakness, RPGClass, position, true, player_data.equips);
